        ...
        <div class="container form-container">
            ...
            <div class="form-row"> 
                ...
                <div class="form-group col-md-9">
                            ...
                            <input type="text" value="<?php echo $res_user['name']; ?>" class="form-control" id="fullNameInitials" name="nameinitial" placeholder="Enter full name with initials">
                 </div>
                ...
                <select class="form-control" id="company" name="company">
                    ...
                    ?>
                        <option value="<?php echo $resCom['com_number'] . '/' . $resCom['com_name']; ?>"
                            <?php echo ($resCom['com_number'] . '/' . $resCom['com_name'] == $res_user['company']) ? 'selected' : ''; ?>>
...
<label for="department">Department</label>
                <select class="form-control" id="department" name="department">
                    ...
                    ?>
                        <option value="<?php echo $resDep['dep_name']; ?>"
                            <?php echo ($resDep['dep_name'] == $res_user['department']) ? 'selected' : ''; ?>>
                            <?php echo $resDep['dep_name']; ?>
                        </option>
                    <?php
                    }
                    ?>
...
<input type="date"  value="<?php echo $res_user['doj']; ?>" class="form-control" id="dob" name="dob3">
</div>
                ...
                <select class="form-control" id="grade" name="grade">
                    ...
                    ?>
                        <option value="<?php echo $resCom['grade']; ?>"
                            <?php echo ($resCom['grade'] == $res_user['ex_grade']) ? 'selected' : ''; ?>>
                    ...
                    <label for="designation">Existing Designation<span style="color:red">*</span></label>
                        ...
                        <option value="<?php echo $resCom['desi_name']; ?>"
                            <?php echo ($resCom['desi_name'] == $res_user['ex_grade']) ? 'selected' : ''; ?>>
