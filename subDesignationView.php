...
if(isset($_GET['user_id'])) {
    ...
    $getuser = mysqli_query($con, "SELECT * FROM sub_designation WHERE id='$user_id'");
...
<?php include 'submenubar.php';?>
    ...
    <div class="container form-container">
        ...
        <h2 class="text-center">Designation details</h2><br><br>
       
        <form>
            <div class="form-group">
                <label for="departmentNumber">Designation Number</label>
                <input type="text" class="form-control" id="departmentNumber" name="depnumber" value="<?php echo $res_user['desi_num']; ?>" readonly>
            </div><br>
            <div class="form-group">
                <label for="departmentName">Designation Name</label>
                <input type="text" class="form-control" id="departmentName" name="depname" value="<?php echo $res_user['desi_name']; ?>" readonly>
            </div>
