...
<div class="mainContainer">
    <div class="container">
        <h3 class="text-whit">Promotions Details</h3>
        ...
        <table id="tableID" class="table table-striped table-bordered">
            ...
            <tbody>
                ...
                if (!empty($searchTerm)) {
                    $getuser = mysqli_query($con, "SELECT id, company, emp_num, name, department FROM promotion 
                ...
                while ($res_user = mysqli_fetch_array($getuser)) {
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="promoView.php?user_id=<?php echo $res_user['id']; ?>" class="btn btn-danger"  style="background-color: green">View</a>
                        </td>
                        <td>
